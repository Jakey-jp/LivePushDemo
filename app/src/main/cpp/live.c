...
Java_com_jakey_live_pusher_PushNative_startPush(JNIEnv *env, jobject instance, jstring url_) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_jakey_live_pusher_PushNative_stopPush(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_jakey_live_pusher_PushNative_release(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_jakey_live_pusher_PushNative_setVideoOptions(JNIEnv *env, jobject instance, jint width,
 ...
 */
JNIEXPORT void JNICALL
Java_com_jakey_live_pusher_PushNative_setAudioOptions(JNIEnv *env, jobject instance,
 ...
 */
JNIEXPORT void JNICALL
Java_com_jakey_live_pusher_PushNative_fireVideo(JNIEnv *env, jobject instance, jbyteArray buffer_) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_jakey_live_pusher_PushNative_fireAudio(JNIEnv *env, jobject instance, jbyteArray buffer_,
                                              jint length) {
